...
export default function Home() {
  ...
  function downloadAnnotation() {
    const payload = { system: '宋词文人通语与南宋临安朗读系统', profile: profiles[profile], dataVersion: '0.8.0-experimental', createdAt: new Date().toISOString(), sourceText: text, analysisText, readings, sentenceData, dominantRhyme, emphasizeRhyme, audio: { sampleRate: RESEARCH_SAMPLE_RATE, renderer: 'deterministic-checked-coda-v5', characterPaddingMs: 20, neuralProxy: neuralModel } };
